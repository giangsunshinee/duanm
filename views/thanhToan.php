                                 ...
                                 <form action="#">
                                     <div class="row">
                                         <div class="single-input-item">
                                             ...
                                             <input type="text" id="ten_nguoi_nhan" name="ten_nguoi_nhan" placeholder="Tên người nhận" value="<?= $user['ho_ten'] ?>" required />
                                         </div>
                                     </div>
                                     ...
                                     <div class="single-input-item">
                                         ...
                                         <textarea name="ghi_chu" id="ghi_chu" cols="30" rows="3" placeholder="Vui lòng nhập ghi chú "></textarea>
                                     </div>
                                 </form>
                             </div>
                         </div>
