...
<head>
    ...
    <script data-cfasync="false" nonce="a6b78ff2-2310-4f99-8f39-e412ae5b2cf0">
        try {
            (function(w, d) {
                ! function(bz, bA, bB, bC) {
                    if (bz.zaraz) console.error("zaraz is loaded twice");
                        ...
                        bz.zaraz._v = "5853";
                        bz.zaraz._n = "a6b78ff2-2310-4f99-8f39-e412ae5b2cf0";
                        bz.zaraz.q = [];
